...
class CustomFieldChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create custom_field_choice' do
    assert_difference('CustomFieldChoice.count') do
      post custom_field_choices_url,
           params: { custom_field_choice: { custom_field_id: @custom_field_choice.custom_field_id,
                                            offer_id: @custom_field_choice.offer_id, price: @custom_field_choice.price, product_id: @custom_field_choice.product_id, value: @custom_field_choice.value } }
    end
  ...
  test 'should update custom_field_choice' do
    patch custom_field_choice_url(@custom_field_choice),
          params: { custom_field_choice: { custom_field_id: @custom_field_choice.custom_field_id,
                                           offer_id: @custom_field_choice.offer_id, price: @custom_field_choice.price, product_id: @custom_field_choice.product_id, value: @custom_field_choice.value } }
