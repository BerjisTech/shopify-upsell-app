...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { description: @feature.description, name: @feature.name, shop_id: @feature.shop_id } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { description: @feature.description, name: @feature.name, shop_id: @feature.shop_id } }
