...
class OfferVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create offer_variant' do
    assert_difference('OfferVariant.count') do
      post offer_variants_url,
           params: { offer_variant: { offer_id: @offer_variant.offer_id, product: @offer_variant.product,
                                      variant: @offer_variant.variant } }
    end
  ...
  test 'should update offer_variant' do
    patch offer_variant_url(@offer_variant),
          params: { offer_variant: { offer_id: @offer_variant.offer_id, product: @offer_variant.product,
                                     variant: @offer_variant.variant } }
