...
class OfferConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create offer_condition' do
    assert_difference('OfferCondition.count') do
      post offer_conditions_url,
           params: { offer_condition: { amount: @offer_condition.amount, block_id: @offer_condition.block_id,
                                        condition_id: @offer_condition.condition_id, content: @offer_condition.content, country: @offer_condition.country, level: @offer_condition.level, offer_id: @offer_condition.offer_id, product_id: @offer_condition.product_id, quantity: @offer_condition.quantity, variant_id: @offer_condition.variant_id } }
    end
  ...
  test 'should update offer_condition' do
    patch offer_condition_url(@offer_condition),
          params: { offer_condition: { amount: @offer_condition.amount, block_id: @offer_condition.block_id,
                                       condition_id: @offer_condition.condition_id, content: @offer_condition.content, country: @offer_condition.country, level: @offer_condition.level, offer_id: @offer_condition.offer_id, product_id: @offer_condition.product_id, quantity: @offer_condition.quantity, variant_id: @offer_condition.variant_id } }
