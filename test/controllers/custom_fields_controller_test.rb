  ...
  test 'should create custom_field' do
    assert_difference('CustomField.count') do
      post custom_fields_url,
           params: { custom_field: { field_type: @custom_field.field_type, name: @custom_field.name,
                                     offer_id: @custom_field.offer_id, placeholder: @custom_field.placeholder, price: @custom_field.price, product_id: @custom_field.product_id, required: @custom_field.required } }
    end
