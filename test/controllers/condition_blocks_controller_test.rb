...
class ConditionBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condition_block" do
    assert_difference('ConditionBlock.count') do
      post condition_blocks_url, params: { condition_block: { offer_id: @condition_block.offer_id, rule: @condition_block.rule } }
    end
  ...
  test "should update condition_block" do
    patch condition_block_url(@condition_block), params: { condition_block: { offer_id: @condition_block.offer_id, rule: @condition_block.rule } }
