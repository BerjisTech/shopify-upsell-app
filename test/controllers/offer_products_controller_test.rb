...
class OfferProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create offer_product" do
    assert_difference('OfferProduct.count') do
      post offer_products_url, params: { offer_product: { name: @offer_product.name, product_id: @offer_product.product_id } }
    end
  ...
  test "should update offer_product" do
    patch offer_product_url(@offer_product), params: { offer_product: { name: @offer_product.name, product_id: @offer_product.product_id } }
