...
class CustomFieldsTest < ApplicationSystemTestCase
  ...
  test "creating a Custom field" do
    ...
    fill_in "Field type", with: @custom_field.field_type
    fill_in "Name", with: @custom_field.name
    fill_in "Offer", with: @custom_field.offer_id
    fill_in "Placeholder", with: @custom_field.placeholder
    fill_in "Price", with: @custom_field.price
    fill_in "Product", with: @custom_field.product_id
    fill_in "Required", with: @custom_field.required
